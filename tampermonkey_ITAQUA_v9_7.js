// ==UserScript==
// @name         Integração SISFOOD x FilaLab (LOJA ITAQUA) - v9.7
// @namespace    http://tampermonkey.net/
// @version      9.7
// @description  Lê a fila do Sisfood e DESPACHA via FilaLab (Itaqua)
// @match        https://app.sisfood.com.br/*
// @grant        none
// ==/UserScript==

(function() {
    console.log("🚀 [FILALAB ITAQUA v9.7] Iniciado!");
    ...
    async function pollComandos() {
         console.log("🔍 [FILALAB ITAQUA] Verificando comandos pendentes...");
         try {
