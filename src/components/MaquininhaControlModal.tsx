    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl sm:max-w-3xl h-[85vh] flex flex-col p-0 overflow-hidden bg-card border-border/50">
                ...
                >
                    <div className="px-6 py-2 bg-muted/30 border-b border-border/5">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 scrollbar-thin scrollbar-thumb-primary/10 hover:scrollbar-thumb-primary/20">
                        ...
                        <TabsContent value="devolver" className="m-0 space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                            {isLoadingVinculos ? (
