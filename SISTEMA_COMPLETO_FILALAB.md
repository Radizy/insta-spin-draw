...
- ✅ **Estabilização e Unificação da Transmissão (RTMP / HLS)**:
    ...
    - Otimização do Polling de Live: O status da transmissão só é buscado continuamente (a cada 8s/15s) se a live estiver online ou se o painel de configurações do OBS estiver aberto. Quando a live está desligada e o painel oculto, a busca em segundo plano é pausada totalmente, eliminando requisições desnecessárias e spam de erros 404 no console.
