// ==UserScript==
// @name         Integração SISFOOD x FilaLab (LOJA POA) - v9.7
// @namespace    http://tampermonkey.net/
// @version      9.7
// @description  Lê a fila do Sisfood e DESPACHA via FilaLab (Poá)
// @match        https://app.sisfood.com.br/*
// @grant        none
// ==/UserScript==

(function() {
    console.log("🚀 [FILALAB POA v9.7] Iniciado!");
    ...
    async function despacharPedidoNoSisfood(cmd) {
         return new Promise((resolve) => {
             ...
             const formMotoboy = "cod_pedido="+encodeURIComponent(codigosLimpos)+"&cod_motoboy="+encodeURIComponent(idMotoboyFinal)+"&nome_motoboy="+encodeURIComponent(cmd.nome_motoboy);
    ...
    async function pollComandos() {
         console.log("🔍 [FILALAB POA] Verificando comandos pendentes...");
         try {
